...
namespace PrintingBooksPortal.Migrations
{
    ...
    [Migration("20260830215345_FeatureSet2_Foundation")]
    partial class FeatureSet2_Foundation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrintingBooksPortal.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrintingBooksPortal.Models.RegisteredPrinter", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ShopId", "AgentKeyHash", "Name")
                        .IsUnique()
            ...
            modelBuilder.Entity("PrintingBooksPortal.Models.RegistrationRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrintingBooksPortal.Models.StudentAnnotationRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StudentUserId", "BookId", "PageNumber")
                        .IsUnique();

                    b.ToTable("StudentAnnotationRecords");
                });

            modelBuilder.Entity("PrintingBooksPortal.Models.StudentBookAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StudentUserId", "BookId")
                        .IsUnique();

                    b.ToTable("StudentBookAccesses");
                });

            modelBuilder.Entity("PrintingBooksPortal.Models.StudentBookmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StudentBookmarks");
                });

            modelBuilder.Entity("PrintingBooksPortal.Models.StudentEnrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StudentUserId", "TenantId")
                        .IsUnique();

                    b.ToTable("StudentEnrollments");
                });

            modelBuilder.Entity("PrintingBooksPortal.Models.StudentNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StudentUserId", "IsRead");

                    b.ToTable("StudentNotifications");
                });

            modelBuilder.Entity("PrintingBooksPortal.Models.StudentReadingProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StudentReadingProgresses");
                });
            ...
            modelBuilder.Entity("PrintingBooksPortal.Models.TeacherAnnouncement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TeacherAnnouncements");
                });
            ...
            modelBuilder.Entity("PrintingBooksPortal.Models.RegistrationRequest", b =>
                {
                    b.HasOne("PrintingBooksPortal.Models.Shop", "CreatedShop")
                        .WithMany()
                        .HasForeignKey("CreatedShopId");

                    b.HasOne("PrintingBooksPortal.Models.Tenant", "CreatedTenant")
            ...
            modelBuilder.Entity("PrintingBooksPortal.Models.StudentAnnotationRecord", b =>
                {
                    ...
                    b.HasOne("PrintingBooksPortal.Models.ApplicationUser", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("PrintingBooksPortal.Models.StudentBookAccess", b =>
                {
                    ...
                    b.HasOne("PrintingBooksPortal.Models.ApplicationUser", "GrantedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PrintingBooksPortal.Models.Tenant", b =>
                {
                    ...
                    b.Navigation("StudentBookAccesses");
